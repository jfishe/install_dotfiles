...
### Created by John D. Fisher ( jfishe ) on 2025-05-23
...
readonly script_created="2025-05-23"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="Install applications and configuration with RCRC."
